...
nonrec theorem ContMDiffAt.continuousAlternatingMap_precomp
    {f : M → F₁ →L[𝕜] F₂}
    (hf : ContMDiffAt I 𝓘(𝕜, F₁ →L[𝕜] F₂) n f x) :
...
theorem ContMDiffOn.continuousAlternatingMap_precomp {f : M → F₁ →L[𝕜] F₂}
    (hf : ContMDiffOn I 𝓘(𝕜, F₁ →L[𝕜] F₂) n f s) :
...
theorem ContMDiff.continuousAlternatingMap_precomp {f : M → F₁ →L[𝕜] F₂}
...
nonrec theorem ContMDiffAt.cle_continuousAlternatingMapCongr
    {f : M → F₁ ≃L[𝕜] F₂} {g : M → F₃ ≃L[𝕜] F₄}
    (hf : ContMDiffAt I 𝓘(𝕜, F₂ →L[𝕜] F₁) n
      (fun x ↦ ((f x).symm : F₂ →L[𝕜] F₁)) x)
    (hg : ContMDiffAt I 𝓘(𝕜, F₃ →L[𝕜] F₄) n
      (fun x ↦ (g x : F₃ →L[𝕜] F₄)) x) :
    ContMDiffAt I 𝓘(𝕜, (F₁ [⋀^ι]→L[𝕜] F₃) →L[𝕜] (F₂ [⋀^ι]→L[𝕜] F₄)) n
      (fun y ↦ ((f y).continuousAlternatingMapCongr (g y) (ι := ι) :
...
theorem ContMDiffOn.cle_continuousAlternatingMapCongr
    {f : M → F₁ ≃L[𝕜] F₂} {g : M → F₃ ≃L[𝕜] F₄}
    (hf : ContMDiffOn I 𝓘(𝕜, F₂ →L[𝕜] F₁) n
      (fun x ↦ ((f x).symm : F₂ →L[𝕜] F₁)) s)
    (hg : ContMDiffOn I 𝓘(𝕜, F₃ →L[𝕜] F₄) n
      (fun x ↦ (g x : F₃ →L[𝕜] F₄)) s) :
    ContMDiffOn I 𝓘(𝕜, (F₁ [⋀^ι]→L[𝕜] F₃) →L[𝕜] (F₂ [⋀^ι]→L[𝕜] F₄)) n
      (fun y ↦ ((f y).continuousAlternatingMapCongr (g y) (ι := ι) :
...
theorem ContMDiff.cle_continuousAlternatingMapCongr
    {f : M → F₁ ≃L[𝕜] F₂} {g : M → F₃ ≃L[𝕜] F₄}
    (hf : ContMDiff I 𝓘(𝕜, F₂ →L[𝕜] F₁) n
      (fun x ↦ ((f x).symm : F₂ →L[𝕜] F₁)))
    (hg : ContMDiff I 𝓘(𝕜, F₃ →L[𝕜] F₄) n
      (fun x ↦ (g x : F₃ →L[𝕜] F₄))) :
    ContMDiff I 𝓘(𝕜, (F₁ [⋀^ι]→L[𝕜] F₃) →L[𝕜] (F₂ [⋀^ι]→L[𝕜] F₄)) n
      (fun y ↦ ((f y).continuousAlternatingMapCongr (g y) (ι := ι) :
